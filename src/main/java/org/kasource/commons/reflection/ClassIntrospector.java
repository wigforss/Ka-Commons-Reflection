...
public interface ClassIntrospector {
     ...
     **/
    <T> Set<Constructor<T>> getConstructorsForType(ConstructorFilter filter, Class<T> ofType)
     ...
     **/
    <T> Constructor<T> getConstructorForType(ConstructorFilter filter, Class<T> ofType);
     ...
     **/
    Constructor<?> getConstructor(ConstructorFilter filter) throws IllegalArgumentException;
     ...
     * @throws IllegalArgumentException if no constructor is found matching the filter.
     **/
    Set<Constructor<?>> getConstructors(ConstructorFilter filter) throws IllegalArgumentException;
