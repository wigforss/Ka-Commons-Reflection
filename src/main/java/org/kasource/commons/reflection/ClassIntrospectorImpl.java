...
public class ClassIntrospectorImpl implements ClassIntrospector {
     ...
     **/
    public ClassIntrospectorImpl(Class<?> target) {
        this.target = target;
    }
     ...
     **/
    @Override
    public <T> Set<Constructor<T>> getConstructorsForType(ConstructorFilter filter, Class<T> ofType) throws IllegalArgumentException {
        if (!ofType.equals(target)) {
            throw new IllegalArgumentException("ofType must be target class: " + target);
        }
        return ConstructorUtils.getConstructorsForType(ofType, filter);
    }
     ...
     **/
    @Override
    public <T> Constructor<T> getConstructorForType(ConstructorFilter filter, Class<T> ofType) {
        if (!ofType.equals(target)) {
            throw new IllegalArgumentException("ofType must be target class: " + target);
        }
        return ConstructorUtils.getConstructorForType(ofType, filter);
    }
     ...
     **/
    @Override
    public Constructor<?> getConstructor(ConstructorFilter filter) throws IllegalArgumentException {
        return ConstructorUtils.getConstructor(target, filter);
     ...
     **/
    @Override
    public Set<Constructor<?>> getConstructors(ConstructorFilter filter) throws IllegalArgumentException {
