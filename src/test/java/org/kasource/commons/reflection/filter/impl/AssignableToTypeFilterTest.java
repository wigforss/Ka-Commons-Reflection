...
public class AssignableToTypeFilterTest {


    private AssignableToTypeFilter filter = new AssignableToTypeFilter(ArrayList.class);

    @Test
    public void passClassTrue() {
        assertThat(filter.apply(List.class), is(true));
    }
