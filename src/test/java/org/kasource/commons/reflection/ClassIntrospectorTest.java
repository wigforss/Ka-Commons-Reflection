...
public class ClassIntrospectorTest {
	...
	public void getMethods() throws SecurityException, NoSuchMethodException {
		...
		assertEquals("The result should include one method", 1, methods.size());
		assertFalse("The result should not contain method1", methods.contains(method1));
		assertFalse("The result should not contain method2", methods.contains(method2));
		assertTrue("The result should contain method3", methods.contains(method3));
	...
	public void getConstructors() throws SecurityException, NoSuchMethodException {
	    ...
	    EasyMockUnitils.replay();
	    Set<Constructor<MyClass>> constructors = introspector.getConstructorsForType(constructorFilter, MyClass.class);
	...
	public void getConstructorsWrongType() {
	    introspector.getConstructorsForType(constructorFilter, MyBase.class);
	}
	...
	public void getConstructor() throws SecurityException, NoSuchMethodException {
        ...
        expect(constructorFilter.passFilter(cons2)).andReturn(true);
        EasyMockUnitils.replay();
	    Constructor<MyClass> constructor = introspector.getConstructorForType(constructorFilter, MyClass.class);
    ...
    public void getConstructorWrongType() {
        introspector.getConstructorForType(constructorFilter, MyBase.class);
    }
